/**
 * @fileoverview KIS 종목 마스터 **데이터의 모양**(증권사 중립). `kis`·`kbsec` 인스턴스가 `options.masterData` 로 받고, 주문 게이트(`trading-hours`)도 쓴다.
 *
...
import type { KRXStock } from './krx-stock-master';
import type { OverseasStock } from './overseas-stock-master';
