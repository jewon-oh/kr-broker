...
const CONDITIONAL_ORDER_PARAMS = ['triggerPrice', 'stopPrice', 'stopLossPrice', 'takeProfitPrice'] as const;
...
export class kis extends Exchange {
     ...
     * - 조건 인자(`triggerPrice`, `stopPrice`, `stopLossPrice`, `takeProfitPrice`)는 요청 없이 `NotSupported` 다. 본문에 합치면 조건 없는
