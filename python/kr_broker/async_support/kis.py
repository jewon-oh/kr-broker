...
class KISAuth:
    ...
    def __init__(self, app_key: str, request_token: Callable[[], Awaitable[Dict[str, Any]]], request_approval_key: Callable[[], Awaitable[str]],
...
class kis(Exchange, ImplicitAPI):
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None,
        ...
        native = await self.candles().fetch_overseas_daily_ohlcv(instrument.code, fallback_exchange, timeframe, limit, since, until)
